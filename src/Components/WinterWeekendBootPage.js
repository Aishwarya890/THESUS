...
import Thesus_giftcard from "../images/Thesus_giftcard.jpg"
...
const initialAccessories = [
...

  {
    ...
    hoverImgSrc: acc1,
    tag: '',
    sizes: [38,36,'ONE SIZE'],
  },
  {
    id: 3,
    name: 'Thesus Gift Card',
    
    imgSrc: Thesus_giftcard,
    hoverImgSrc: Thesus_giftcard,
    price:'From AFN. 5,296.73',
    sizes: ['ONE SIZE']
    
  },
];

const WinterWeekendBootPage = () => {
  ...
  return (
    <div className="container my-5">
      <h1 className="mb-4">The Winter Weekend Boot Z</h1>
...
export default WinterWeekendBootPage;
